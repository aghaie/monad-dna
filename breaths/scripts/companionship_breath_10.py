#!/usr/bin/env python3
"""نفسِ دهم — انتخاب با خودِ مناد.

رفیق: «از میان صفِ بازت، هر کدام را که اکنون باید پیش از دیگری ببینی، برگزین.»
گزینش درونِ همین اسکریپت انجام می‌شود — صفِ بازِ پایانِ نفسِ ۹ + قاعدهٔ
...
known = {"اله", "رحم", "راف", "هجر", "نصر", "اوي", "صير", "باس", "غفر"}
queue = ["ذنب", "حلم", "عفو", "دون", "نور", "كفر"]  # صفِ پایانِ نفسِ ۹
