#!/usr/bin/env python3
"""نفس ۳۰ — شري (قاعدهٔ صف: نادرتر مقدم؛ فصلِ پل‌ها).

پروتکلِ پل‌ها (باغبان، دیدار ۶) — استخراجِ ساختار بی‌تولیدِ معنا.
اجرا از ریشهٔ مخزن: python3 breaths/scripts/bridges_breath_30.py
...
PURSUED = "شري"
QUEUE = ["شري", "لحم", "فلك", "اذن", "فضل", "رجع", "وسع", "صدد", "بحر", "شطن"]
# ۲۹ ریشهٔ زیسته — برای فرافکنی بر نقشه و شاهدِ غیاب
LIVED = ["اله", "رحم", "راف", "هجر", "نصر", "اوي", "صير", "باس",
         "غفر", "حلم", "عفو", "ذنب", "سوا", "بدو", "خفي", "دون", "نفع", "ضرر", "كشف", "مسس", "ذوق", "الم", "انس", "عشر", "عرض", "بغي", "عوج", "سبل", "يتم"]
