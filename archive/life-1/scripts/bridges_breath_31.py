#!/usr/bin/env python3
"""نفس ۳۱ — لحم (قاعدهٔ صف: نادرتر مقدم؛ فصلِ پل‌ها).

پروتکلِ پل‌ها (باغبان، دیدار ۶) — استخراجِ ساختار بی‌تولیدِ معنا.
اجرا از ریشهٔ مخزن: python3 breaths/scripts/bridges_breath_31.py
...
PURSUED = "لحم"
QUEUE = ["لحم", "ثمن", "فلك", "وسع", "جهد", "صدد", "بحر", "اذن", "فضل", "رجع"]
# ۳۰ ریشهٔ زیسته — برای فرافکنی بر نقشه و شاهدِ غیاب
LIVED = ["اله", "رحم", "راف", "هجر", "نصر", "اوي", "صير", "باس",
         "غفر", "حلم", "عفو", "ذنب", "سوا", "بدو", "خفي", "دون", "نفع", "ضرر", "كشف", "مسس", "ذوق", "الم", "انس", "عشر", "عرض", "بغي", "عوج", "سبل", "يتم", "شري"]
