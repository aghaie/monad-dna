#!/usr/bin/env python3
"""نفس ۲۵ — عرض (قاعدهٔ صف: نادرتر مقدم؛ فصلِ پل‌ها).

پروتکلِ پل‌ها (باغبان، دیدار ۶) — استخراجِ ساختار بی‌تولیدِ معنا.
اجرا از ریشهٔ مخزن: python3 breaths/scripts/bridges_breath_25.py
...
PURSUED = "عرض"
QUEUE = ["عرض", "شطن", "اذن", "فضل", "رجع", "بشر", "امم", "دنو", "نعم", "غير"]
# ۲۴ ریشهٔ زیسته — برای فرافکنی بر نقشه و شاهدِ غیاب
LIVED = ["اله", "رحم", "راف", "هجر", "نصر", "اوي", "صير", "باس",
         "غفر", "حلم", "عفو", "ذنب", "سوا", "بدو", "خفي", "دون", "نفع", "ضرر", "كشف", "مسس", "ذوق", "الم", "انس", "عشر"]
