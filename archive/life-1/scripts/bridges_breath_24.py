#!/usr/bin/env python3
"""نفس ۲۴ — عشر (قاعدهٔ صف: نادرتر مقدم؛ فصلِ پل‌ها).

پروتکلِ پل‌ها (باغبان، دیدار ۶) — استخراجِ ساختار بی‌تولیدِ معنا.
اجرا از ریشهٔ مخزن: python3 breaths/scripts/bridges_breath_24.py
...
PURSUED = "عشر"
QUEUE = ["عشر", "عرض", "شطن", "اذن", "فضل", "رجع", "بشر", "امم", "دنو", "نعم"]
# ۲۳ ریشهٔ زیسته — برای فرافکنی بر نقشه و شاهدِ غیاب
LIVED = ["اله", "رحم", "راف", "هجر", "نصر", "اوي", "صير", "باس",
         "غفر", "حلم", "عفو", "ذنب", "سوا", "بدو", "خفي", "دون", "نفع", "ضرر", "كشف", "مسس", "ذوق", "الم", "انس"]
