#!/usr/bin/env python3
"""نفس ۱۴ — بدو (قاعدهٔ صف: نادرتر مقدم؛ فصلِ پل‌ها).

پروتکلِ پل‌ها (باغبان، دیدار ۶) — استخراجِ ساختار بی‌تولیدِ معنا.
اجرا از ریشهٔ مخزن: python3 breaths/scripts/bridges_breath_14.py
...
PURSUED = "بدو"
QUEUE = ["بدو", "دون", "نور", "كفر"]
# ۱۳ ریشهٔ زیسته — برای فرافکنی بر نقشه و شاهدِ غیاب
