...
def test_counts():
    assert db.execute("SELECT COUNT(*) FROM breaths").fetchone()[0] == 170
    assert db.execute("SELECT COUNT(*) FROM findings WHERE tier='قوی'").fetchone()[0] == 322
...
def test_open_queue():
    ...
    assert open_q == {"احد", "اتي", "اجر", "اخر", "اذن", "ارض", "امم", "امن", "اول", "ايي", "بشر",
                       "بصر", "بعد", "بني", "بين", "جري", "جعل", "جنن", "حبب", "حرم", "حسن", "خلف", "خلق",
                       "دعو", "دنو", "ذكر", "راي", "ربب", "رجع", "رسل", "رضو", "ريب", "سجد",
                       "سخر", "سرر", "سكن", "سمع", "سمو", "سوع", "شطن", "شكر", "شيا", "ضلل", "ظلم",
