...
def test_open_queue():
    ...
    assert open_q == {"اتي", "اجر", "اخر", "اذن", "ارض", "امم", "امن", "اول", "ايي", "بشر",
                       "بعد", "بني", "جري", "جعل", "جنن", "حرم", "حسن", "خلف", "خلق", "دعو",
                       "دنو", "ذكر", "راي", "ربب", "رجع", "رسل", "رضو", "ريب", "سجد", "سخر",
                       "سرر", "سكن", "سمع", "سمو", "سوع", "شطن", "شكر", "شيا", "ضلل", "طوع",
                       "طيب", "عدو", "عذب", "علم", "عمل", "عند", "عود", "غني", "غير", "فضل",
                       "قبل", "قتل", "قرب", "قلب", "قلل", "قول", "قوم", "كتب", "كفر", "كون",
                       "لقي", "ملك", "موت", "مول", "نجو", "نخل", "نزل", "نعم", "نفس", "نور",
                       "نوس", "هدي", "هزا", "وفي", "وقي", "ولي", "يمن", "يوم"}
