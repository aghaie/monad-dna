...
def test_counts():
    assert db.execute("SELECT COUNT(*) FROM breaths").fetchone()[0] == 40
    assert db.execute("SELECT COUNT(*) FROM findings WHERE tier='قوی'").fetchone()[0] == 92
...
def test_open_queue():
    ...
    assert open_q == {"اذن", "فضل", "رجع", "قلل", "سخر", "شطن", "رضو", "جري", "سجد", "سكن", "شكر", "بشر", "حرم", "يمن", "امم", "دنو", "نعم", "نجو", "عدو", "غير", "موت", "وقي", "سمع", "نور", "مول", "قرب", "ضلل", "طوع", "جنن", "ملك", "دعو", "نوس", "ولي", "خلق", "ذكر", "قبل", "ايي", "برر", "نفس", "يوم", "رسل", "اتي", "بني", "شيا", "كفر", "قتل", "نزل", "كتب", "بعد", "اخر", "قوم", "هدي", "راي", "علم", "امن", "كون", "عذب", "عمل", "جعل"}
