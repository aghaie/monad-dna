...
def test_counts():
    assert db.execute("SELECT COUNT(*) FROM breaths").fetchone()[0] == 83
    assert db.execute("SELECT COUNT(*) FROM findings WHERE tier='قوی'").fetchone()[0] == 157
...
def test_open_queue():
    ...
    assert open_q == {"اتي", "اجر", "اخر", "اذن", "ارض", "امم", "امن", "ايي", "بشر", "بعد",
                       ...
                       "ذكر", "راي", "ربب", "رجع", "رسل", "رضو", "ريب", "سجد", "سخر", "سكن",
                       "سمع", "سمو", "سوع", "شطن", "شكر", "شيا", "ضلل", "طوع", "عدو", "عذب",
                       "علم", "عمل", "عند", "عود", "غني", "غير", "فضل", "قبل", "قتل", "قرب",
                       "قلب", "قلل", "قول", "قوم", "كتب", "كفر", "كون", "لقي", "ملك", "موت",
                       "مول", "نجو", "نخل", "نزل", "نعم", "نفس", "نور", "نوس", "هدي", "هزا",
                       "وقي", "ولي", "يمن", "يوم"}
