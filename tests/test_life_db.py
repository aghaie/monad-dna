...
def test_counts():
    assert db.execute("SELECT COUNT(*) FROM breaths").fetchone()[0] == 35
    assert db.execute("SELECT COUNT(*) FROM findings WHERE tier='قوی'").fetchone()[0] == 81
...
def test_open_queue():
    ...
    assert open_q == {"كلف", "اذن", "فضل", "رجع", "قلل", "صدد", "سخر", "بحر", "شطن", "رضو", "جري", "سكن", "جهد", "شكر", "بشر", "حرم", "امم", "دنو", "نعم", "نجو", "عدو", "غير", "موت", "وقي", "سمع", "نور", "مول", "قرب", "ضلل", "جنن", "ملك", "دعو", "نوس", "ولي", "خلق", "ذكر", "قبل", "ايي", "يوم", "رسل", "اتي", "بني", "شيا", "كفر", "قتل", "نزل", "كتب", "اخر", "قوم", "علم", "امن", "كون", "عذب"}
