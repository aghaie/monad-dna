...
def test_counts():
    assert db.execute("SELECT COUNT(*) FROM breaths").fetchone()[0] == 23
    assert db.execute("SELECT COUNT(*) FROM findings WHERE tier='قوی'").fetchone()[0] == 56
...
def test_open_queue():
    ...
    assert open_q == {"عشر", "اذن", "فضل", "رجع", "عرض", "شطن", "بشر", "امم", "دنو", "نعم", "غير", "موت", "نور", "ضلل", "جنن", "ملك", "دعو", "نوس", "ولي", "خلق", "قبل", "ايي", "يوم", "شيا", "كفر", "علم", "امن", "كون", "عذب"}
