...
def test_counts():
    assert db.execute("SELECT COUNT(*) FROM breaths").fetchone()[0] == 47
    assert db.execute("SELECT COUNT(*) FROM findings WHERE tier='قوی'").fetchone()[0] == 105
...
def test_open_queue():
    ...
    assert open_q == {"اتي", "اخر", "اذن", "ارض", "امم", "امن", "ايي", "بشر", "بعد", "بني",
                       "جري", "جعل", "جنن", "حرم", "خلف", "خلق", "دعو", "دنو", "ذكر", "راي",
                       "رجع", "رسل", "رضو", "سجد", "سخر", "سكن", "سمع", "سمو", "شطن", "شكر",
                       "شيا", "ضلل", "طوع", "عدو", "عذب", "علم", "عمل", "غير", "فضل", "قبل",
                       "قتل", "قرب", "قلب", "قلل", "قول", "قوم", "كتب", "كفر", "كون", "ملك",
                       "موت", "مول", "نجو", "نزل", "نعم", "نفس", "نور", "نوس", "هدي", "وقي",
                       "ولي", "يمن", "يوم"}
